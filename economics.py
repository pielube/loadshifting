...
def CashFlows(conf,prices,fromgrid,togrid):
    ...
    res = EnergyBuyAndSell2(conf,enpricekWh, gridfeekWh, enpricekWh_sell, fromgrid, togrid, prostax)
...
def EnergyBuyAndSell2(conf,enpricekWh, gridfeekWh, enpricekWh_sell, fromgrid,togrid, prostax):
