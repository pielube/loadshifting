...
# res = pvlib.iotools.get_pvgis_hourly(latitude,longitude,pvcalculation=True,peakpower=0.001,loss=20.)
# weather = pvlib.iotools.get_pvgis_tmy(latitude, longitude, startyear=2006,endyear=2016,map_variables=True)[0]
# weather.index.name = "utc_time"

# index = weather.index
# index = index.shift(10,freq='min')
...
# pv.loc['2015-12-31 23:15:00'] = [None]
# pv.loc['2015-12-31 23:30:00'] = [None]
# pv.loc['2015-12-31 23:45:00'] = [None]
# pv = pv.fillna(method='ffill') # W

# # Saving results
# path = r'.\simulations'
# if not os.path.exists(path):
#     os.makedirs(path)
# filename = 'pv_pvgis.pkl'
# filename = os.path.join(path,filename)
# pv.to_pickle(filename)
