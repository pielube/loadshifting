...
from launcher_shift_functions import MostRepCurve,AdmTimeWinShift,DHWShiftTariffs,HouseHeating,ResultsAnalysis,WriteResToExcel
...
for jjj in idx_casestobesim:
    ...
    if WetAppBool:
        ...
        for app in WetAppShift:
            ...
            # app_n,ncyc,ncycshift,enshift = shift_appliance(demands['results'][idx][app][:-1],admtimewin,probshift,max_shift=24*60)
